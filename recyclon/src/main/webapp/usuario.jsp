        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ms-auto mb-2 mb-lg-0"> <!--ms-auto para desplazar-->
                  ...
                  <li class="nav-item">
                      <a class="nav-link active text-light" href="#">Productos</a>
                  </li>
                  <li class="nav-item">
                      <a class="nav-link active text-light" href="#">Lineas Pedidos</a>
                  </li>
              </ul>  
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ms-auto mb-2 mb-lg-0"> <!--ms-auto para desplazar-->
                  ...
                  <li class="nav-item">
                      <a class="nav-link active text-light" aria-current="page" href="#">Usuario</a>
                  </li>
                  <li class="nav-item">
    ...
    <div class="container-fluid  justify-content-center align-items-center mt-5">
       <div class="col-8 offset-2 p-5">
                <div class="accordion mt-5" id="accordionUser">
                    ...
                    <div class="container-fluid  justify-content-center align-items-center mt-5">
                    	<button class="btn btn-outline-success rounded" href="pedidos?accion=verPedidosUsuario">Ver Pedidos</button>
                    </div>
                </div>
            </div>
        </div>    
