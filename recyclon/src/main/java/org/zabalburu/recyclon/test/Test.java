package org.zabalburu.recyclon.test;
...
public class Test {
	 ...
	 public static void main(String[] args) {
	        ...
	        System.out.println("=== TEST CONTRASEÑAS ===");



	        // 1️ Crear hash de una contraseña
	        ...
	        // 3️ Verificar password incorrecta
	        ...
	        // 4️ Generar hash para admin (para insertar en BD)
